...
modelo_lstm.save_weights('lstm_pesos.weights.h5')
...
plt.plot(y_pred_lstm[:n_points_to_show], label='Predição LSTM', color='orange')
plt.title('Previsão de Precipitação com LTSM')
plt.xlabel('Tempo')
...
plt.savefig('grafico_predicao_LSTM.png', format='png', dpi=300, bbox_inches='tight')
